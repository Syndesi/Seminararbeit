      ...
      <div className="container">
        ...
        <form>
          ...
          <div className="form-group">
            ...
            <input type="email" onChange={this.updateFormData.bind(this)} className="form-control" id="email" aria-describedby="admin email" placeholder={l.emailPlaceholder}  value={s.form.email}/>
          </div>
          <div className="form-row">
            <div className="form-group col-md-6">
          ...
          <button className="btn btn-primary" onClick={this.sendLoginRequest.bind(this)} type="button">{l.register}</button>
        </form>
      </div>
    );
  }
