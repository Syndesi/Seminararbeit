...
abstract class AuthorizedQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query on the is_authorized column
     *
     * Example usage:
     * <code>
     * $query->filterByIsAuthorized(true); // WHERE is_authorized = true
     * $query->filterByIsAuthorized('yes'); // WHERE is_authorized = true
     * </code>
     *
     * @param     boolean|string $isAuthorized The value to use as filter.
